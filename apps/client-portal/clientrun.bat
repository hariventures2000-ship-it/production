@echo off
title Mervi Platform - Client Portal Dev Env
echo ==========================================================
echo Starting Mervi Client Portal Dev Environment...
echo ==========================================================
...
echo Starting Client Portal Frontend on http://localhost:3009...
