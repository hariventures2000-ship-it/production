@echo off
title Mervi Platform - Super Admin Portal Dev Env
echo ==========================================================
echo Starting Mervi Super Admin Portal Dev Environment...
echo ==========================================================
...
echo Starting Super Admin Portal Frontend on http://localhost:3000...
