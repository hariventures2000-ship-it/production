@echo off
title Mervi Platform - Team Lead Portal Dev Env
echo ==========================================================
echo Starting Mervi Team Lead Portal Dev Environment...
echo ==========================================================
...
echo Starting Team Lead Portal Frontend on http://localhost:3007...
