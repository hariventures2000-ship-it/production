@echo off
title Mervi Platform - Employee Portal Dev Env
echo ==========================================================
echo Starting Mervi Employee Portal Dev Environment...
echo ==========================================================
...
echo Starting Employee Portal Frontend on http://localhost:3005...
